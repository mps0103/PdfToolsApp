...
export default function Splash({ onDone }: Props) {
  ...
  useEffect(() => {
    Animated.sequence([
      // Held, not faded in: the native splash has already drawn this same
      // image, so fading it in would look like a stutter.
      Animated.delay(1700),
      Animated.timing(out, {
        toValue: 0,
        duration: 320,
    ...
    // Total: about 2 seconds, most of it the hold.
  }, [out, onDone]);
